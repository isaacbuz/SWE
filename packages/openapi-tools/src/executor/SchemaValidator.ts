...
export class SchemaValidator {
   ...
   */
  private arraySchema(jsonSchema: Record<string, unknown>): z.ZodArray<z.ZodTypeAny> {
   ...
   */
  private objectSchema(jsonSchema: Record<string, unknown>): z.ZodObject<Record<string, z.ZodTypeAny>> {
    ...
    for (const [key, propSchema] of Object.entries(properties)) {
      const zodProp = this.jsonSchemaToZod(propSchema as Record<string, unknown>);
