...
} from "../permissions/PermissionChecker.js";
...
export class ToolExecutor {
  ...
  constructor(options: ToolExecutorOptions = {}) {
    ...
    this.circuitBreaker =
      this.options.circuitBreakerInstance || new CircuitBreaker();
   ...
   */
  registerTool(name: string, handler: ToolHandler, spec?: ToolSpec): void {
