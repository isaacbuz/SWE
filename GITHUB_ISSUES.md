# GitHub Issues - AI-First Software Engineering Company
...
**Labels**: `skills`, `backend`, `core-feature`
...
- [ ] Category navigation
- [ ] Skills detail page with tabs (Overview, Documentation, Playground, Reviews, Versions)
- [ ] Skills playground for testing
- [ ] Install/uninstall functionality
- [ ] My Skills page (Installed, Created, Favorites)
...
- `/skills/create` - Skills creator wizard
...
- `SkillCreator` - Multi-step wizard
...
- `apps/web/app/(dashboard)/skills/create/page.tsx`
- `apps/web/app/(dashboard)/skills/analytics/page.tsx`
...
**Priority**: Medium
**Assignee**: AI/ML Team
**Labels**: `skills`, `content`, `ai`

**Description**:
Create a library of built-in Skills covering common software engineering tasks.
...
- `packages/skills-library/documentation/*.yaml`
- `packages/skills-library/architecture/*.yaml`

**Estimated Effort**: 8 days (2 skills per day)
...
4. Deploy API services (3+ replicas)
5. Deploy frontend to Vercel/CDN
...
- `area:moe-router` - MoE Router
- `area:workflows` - Temporal workflows
...
- `status:ready-to-test` - Ready for QA
...
1. **Pick an issue**: Browse open issues, filter by label
2. **Assign yourself**: Comment to claim the issue
3. **Create branch**: `git checkout -b feature/issue-XX-description`
...
**Team Size**: 18 agents + 1-3 human engineers
